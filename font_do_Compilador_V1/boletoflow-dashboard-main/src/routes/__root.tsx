...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "BoolEto — Automação de Contas a Pagar" },
      { name: "description", content: "Microserviço para extrair, organizar e automatizar boletos bancários via OCR e API." },
      { name: "author", content: "BoolEto" },
      { property: "og:title", content: "BoolEto — Automação de Contas a Pagar" },
      { property: "og:description", content: "Extração via OCR, agendamento inteligente e API JSON para boletos." },
